...
<div class="container">
    <div class="row">
        <div class="col-3 mt-3 mr-3 ">
            <img src="<?= $student->getPicture() ?>" class="img-thumbnail" alt="Photo de l\'étudiant 1">
        </div>
        <div class="col-9">
            <div class="row mt-3 ms-3 align-items">
                <div class="col-12 my-3">
                    <h2>
                        <?= htmlentities($student->getLastName()) ?>
                        <?= htmlentities($student->getFirstName()) ?>
                    </h2>
                </div>
                <div class="col-12 my-3">
                    <h5>
                        login:
                        <?= htmlentities($student->getLogin()) ?>
                    </h5>
                </div>

                <div class="col-12 ">
                    <button type="button" class="btn btn-primary mt-3" data-bs-toggle="modal"
                        data-bs-target="#ModalModifie" data-id="<?= $student->getId() ?>">
                ...
                <form action="<?= $_SERVER["REQUEST_URI"] ?>" method="POST">
                    <div class="row">
                        <div class=" col-5 text-center mt-1">
                            <img src="<?= $student->getPicture() ?>" class=" w-75 border border-3" alt="Image formation">
                        </div>
                        <div class="col-7">
                            <div class="  col-12 ">
                                <label for="FormName" class="form-label pe-none"></label>
                                <input class=" form-control" id="FormName" value="<?= $student->getLastName()?>"name="name">
                            </div>
                            <div class=" col-12 ">
                                <label for="FormFirstName" class="form-label pe-none"></label>
                                <input class=" form-control" id="FormFirstName" value="<?= $student->getFirstName() ?>" name="firstname">
                            </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-7 ">
                            <input class=" form-control" id="test" value="<?= $student->getLogin() ?>" name="login">
                        </div>
                        ...
                        <div class="col-7 mt-4">
                            <select id="passwdSelect" class="form-select">
                                <option <?php if ($student->getTypePwd() === "texte")
                                    echo 'selected' ?>>Texte
                                    </option>
                                    <option <?php if ($student->getTypePwd() === "schéma")
                                    echo 'selected' ?>>Schéma
                                    </option>
                                    <option <?php if ($student->getTypePwd() === "code")
                                    echo 'selected' ?>>Code
                                    </option>
                                </select>
                            </div>
                            ...
                            <div id="champCode" class="champ" style="display: none;">
                                <div class="row align-items-center mt-4">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control" id="codeField" type="password" name="code">
                                    </div>
                                </div>
                                <div class="row align-items-center mt-4 mb-2">
                                    <div class="col-5 text-center">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control champ-form" id="codeFieldConfirm" type="password" name="code-confirm">
                                    </div>
                                </div>
                            </div>
