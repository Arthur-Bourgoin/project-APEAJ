...
<div class="container mt-5">
    ...
    foreach ($students as $student) { 
        ...
        ?>
        <div class="card mb-4 mx-lg-2 mx-md-1 mx-2 col-lg-3 col-md-3 col-5 border-dark" data-typemdp="<?= $student["typemdp"] ?>" data-login-student="<?= $student["login"] ?>" data-bs-toggle="modal" data-bs-target="#<?=$target?>">
