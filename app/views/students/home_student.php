...
<div class="container mt-5">
    <div class="row mb-4">
        <h2 class="col-12">Bienvenue <?=htmlentities($student["prenom"])?> !</h2>
    </div>
        ...
        <div class="row">
            <?php ?>
                <div class="col-3 text-center">
                    ...
                    <h4 class="col-12">Session <?=htmlentities($currentSheet["ID"])?></h4>
                    <a href="fiche-<?=$currentSheet["ID"]?>">
    ...
    <div class="container-finish mb-5 mt-2">
        ...
        <div class="row">
            <?php foreach ($finishedSheets as $finish) { ?>
                <div class="col-3 text-center">
                    <i class="bi bi-file-earmark-text" style="font-size: 8rem;"></i>
                    <div>
                        <h4>Session <?=htmlentities($finish["ID"])?></h4>
                        <a href="fiche-<?=$finish["ID"]?>">
